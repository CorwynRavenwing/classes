    ...
    def maxProfit(self, prices: List[int]) -> int:
        ...
        for P in prices:
            ...
            if old_money_with is not None:
                # sell the stock
                new_money_without = old_money_with + P
            ...
            best_values = (
                max(old_money_without, new_money_without) if old_money_without is not None else new_money_without,
                max(old_money_with, new_money_with) if old_money_with is not None else new_money_with,
            )
            print(f'{best_values}')
