class Solution:
    def numberOfPairs(self, points: List[List[int]]) -> int:
        ...
        # After spending several hours working out exclusive sets for
        # "on the upper left side of", and *inclusive* sets for "inside the box",
        # I have realized that they mean for the "upper left" set to also
        # be inclusive, i.e. 1,2 is "upper left" of both 1,1 and 2,2
...
# NOTE: Runtime 725 ms Beats 7.69%
# NOTE: Memory 17.70 MB Beats 9.23%

# NOTE: re-ran for challenge:
# NOTE: Runtime 631 ms Beats 5.13%
# NOTE: Memory 18.84 MB Beats 2.56%
